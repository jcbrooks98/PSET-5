...
logwage <- log(PDeurlat$Wage)
plot(logwage, PDeurlat$Acceleration, main = 'Log of Wage ~ Acceleration')

plot(PDeurlat$Wage, PDeurlat$Stamina, main = 'Stamina ~ Acceleration')
