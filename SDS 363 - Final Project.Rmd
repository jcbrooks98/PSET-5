...
CSQPlot(PDeurlat[PDeurlat$Region == "Europe", c("Acceleration", "Stamina")],label= "Europe")
CSQPlot(PDeurlat[PDeurlat$Region == "LatinAmerica", c("Acceleration", "Stamina")],label= "LatinAmerica")
```

```{r}
#Make labels vector
responsevec <- c("Acceleration", "Stamina")
for (i in c("Acceleration", "Stamina")){
  boxplot(PDeurlat[,i] ~ Region, data = PDeurlat, col = 'yellow', ylab = "")
