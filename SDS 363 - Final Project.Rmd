...
```
*Wage seems to have a very weak, positive, linear relationship with both Acceleration and Stamina. However, it is almost indiscernable given that Wage is so heavily left skewed (SHOULD WE MAKE A TRANSFORMATION TO WAGE TO HELP THIS???)*
