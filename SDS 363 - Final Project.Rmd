...
logsprint <- log(PDeurlat$SprintSpeed)
plot(logsprint, PDeurlat$Acceleration, main = 'Log of Sprint Speed ~ Acceleration')

#plot(PDeurlat$Stamina, PDeurlat$Acceleration, main = 'Stamina ~ Acceleration')
logstamina <- log(PDeurlat$Stamina)
plot(logstamina, PDeurlat$Acceleration, main = 'Log of Stamina ~ Acceleration')
```
