...
```{r}
plot(PDeurlat$Balance, PDeurlat$Acceleration, main = 'Balance ~ Acceleration')
...
```{r}
mod2 <- lm(as.matrix(PDeurlat[,c("Acceleration", "Stamina", "Balance", "HeadingAccuracy")]) ~ PDeurlat$Region + PDeurlat$InternationalReputation + PDeurlat$Wage +  PDeurlat$Region*PDeurlat$InternationalReputation) 
