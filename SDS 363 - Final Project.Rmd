...
```{r}
plot(fact_ml$loadings, pch=18, col='red', main="Loading Plot for First Two Factors",xlab="First Factor: Axis of Ball Control", ylab="Second Factor: Axis of Ball Pressure")
abline(h=0)
abline(v=0)
